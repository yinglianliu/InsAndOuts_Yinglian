...
//  valDistance = int (map(distance,0,100,0,100));
//  delay(10);
...
//    }
    ...
    ampMap=map(valueOfAmp,0,255,0,5);
    ampMap2 = map(valueOfAmp,0,255,0,255);
   for(int i=0; i<NUM_LEDS;i++){
      leds[i] = CRGB(8*i,255-8*i,ampMap2);
